...
export const FocusMode: React.FC<FocusModeProps> = ({ activeTask, onExit, onComplete }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-dark-bg flex flex-col items-center justify-center overflow-hidden animate-in fade-in duration-700">
            ...
            {/* Background Effects */}
            <div className={`absolute inset-0 bg-gradient-to-b from-neon-cyan/10 to-dark-bg pointer-events-none transition-opacity duration-[4000ms] ${pulse ? 'opacity-50' : 'opacity-20'}`} />
            ...
            <div className="relative z-10 w-full max-w-4xl p-8 flex flex-col items-center text-center">
                ...
                <div className="relative mb-12 group">
                    <div className={`absolute inset-0 rounded-full bg-neon-cyan/20 blur-3xl transition-all duration-[4000ms] ${pulse ? 'scale-110 opacity-40' : 'scale-90 opacity-10'}`}></div>
